# 20241202-Android AVB 分析（二）AVB 2.0 自述文档(v1.3 版-20250118)
...
另外，除了阅读翻译后的本文之外，我也建议你对比英文原文以加深理解。因为有些东西，英语表述经过翻译之后内容就会变得奇奇怪怪的。例如，在我看来 bootloader 这样的词起始很清晰，就是指类似 u-boot 这样的一个启动加载程序，但有些文档中翻译成启动器或者启动加载器。说实话，一看中文名称，真的要反应一会儿才能和 bootloader 这个每天都要接触的词语联系在一起。
